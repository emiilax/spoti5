...
public class CompanyTest extends AndroidTestCase {
    ...
    public CompanyTest() {
        ...
        mcDonalds = new Company("MC Donalds", bert, 12);
        burgerKing = new Company("Burger King", bert, 45);
        max = new Company("MAX", bert, 1200);
        pizzaHut = new Company("Pizza Hut", bert, 130);
